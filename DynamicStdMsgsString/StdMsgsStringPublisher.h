...
/**
 * @file StdMsgsStringPublisher.h
 *
 */

#ifndef STD_MSGS_STRING_PUBLISHER_H_
#define STD_MSGS_STRING_PUBLISHER_H_
...
class StdMsgsStringPublisher
{
    public:

        StdMsgsStringPublisher();

        virtual ~StdMsgsStringPublisher();
    ...
    private:
        ...
        // Dynamic Types
        eprosima::fastrtps::types::DynamicData* m_DynStdMsgsString;
        eprosima::fastrtps::types::DynamicPubSubType m_DynType;
};



#endif /* STD_MSGS_STRING_PUBLISHER_H_ */
